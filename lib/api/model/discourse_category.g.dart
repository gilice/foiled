...
const DiscourseCategorySchema = Schema(
...
void _discourseCategorySerialize(
  ...
  writer.writeLong(offsets[5], object.postCount);
  writer.writeString(offsets[6], object.slug);
  writer.writeLong(offsets[7], object.topicCount);
  writer.writeString(offsets[8], object.topicUrl);
}
...
DiscourseCategory _discourseCategoryDeserialize(
  ...
  final object = DiscourseCategory(
    ...
    postCount: reader.readLongOrNull(offsets[5]),
    slug: reader.readStringOrNull(offsets[6]),
    topicCount: reader.readLongOrNull(offsets[7]),
    topicUrl: reader.readStringOrNull(offsets[8]),
  );
  return object;
}

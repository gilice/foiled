...
const AccountSchema = CollectionSchema(
  ...
  links: {
    r'server': LinkSchema(
      id: 1896073552109420986,
      name: r'server',
      target: r'DiscourseServer',
      single: true,
    )
  },
  embeddedSchemas: {},
...
void _accountAttach(IsarCollection<dynamic> col, Id id, Account object) {
  object.id = id;
  object.server
      .attach(col, col.isar.collection<DiscourseServer>(), r'server', id);
}
...
extension AccountQueryLinks
    on QueryBuilder<Account, Account, QFilterCondition> {
  QueryBuilder<Account, Account, QAfterFilterCondition> server(
      FilterQuery<DiscourseServer> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'server');
    });
  }

  QueryBuilder<Account, Account, QAfterFilterCondition> serverIsNull() {
    return QueryBuilder.apply(this, (query) {
